      ...
      <main className="flex-1 p-6 flex gap-6">
        <div className="flex flex-col flex-1 gap-4">
          ...
          <p className="text-sm text-muted-foreground">
            Lembre-se: você precisa utilizar a variável{" "}
        ...
        <aside className="w-80 space-y-6">
          <form className="space-y-6">
            ...
            <Button
              type="submit"
              className="bg-white w-full hover:bg-primary/90"
            >
              Carregar vídeo
          ...
          <form className="space-y-6">
            ...
            <Button type="submit" className="bg-white w-full hover:bg-primary/90">
              Executar
